...
const ExportData = () => {
    ...
    const handleExport = async (format) => {
        try {
            ...
            a.href = url;
            // Content-Disposition header should handle filename, but we can fallback
            // Actually, standard fetch doesn't auto-handle download without <a download>
            // We will parse filename from header if possible, or use default.
