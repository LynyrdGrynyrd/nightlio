...
const getInterpretation = (score) => {
    const { THRESHOLDS, CONFIG_COLORS, LABELS } = CHART_CONFIG.STABILITY; // Destructuring for cleaner access?
    // Actually direct access is fine or helper
...
const MoodStability = () => {
    ...
    // Maybe filter out leading zeros? Or connect nulls?
    // Let's just use what we have, Recharts handles it.
