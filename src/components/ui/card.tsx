...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[calc(var(--radius)+2px)] border border-border/70 bg-card/90 text-card-foreground shadow-sm backdrop-blur-[2px] transition-[border-color,box-shadow,transform] duration-200",
      className
    )}
    {...props}
  />
