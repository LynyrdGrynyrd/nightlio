    ...
    <div className="about-page landing">
      ...
      <main className="about__content">
        ...
        <section className="about__section">
          ...
          <p>
            If you find this project useful, please consider leaving a star on the <a href="https://github.com/shirsakm/twilightio">GitHub repo</a>—it really helps new users trust lesser-known projects.
          </p>
        </section>
      </main>
